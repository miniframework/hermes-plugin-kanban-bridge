...
![Hermes Task Market — Product Overview](product@2x.png)

### Technical Architecture

![Hermes Task Market — Technical Architecture](architecture@2x.png)

### Local Task Progress

![Kanban Board — Local Task Monitoring](kanban.png)
...
## Part 2: Install Kanban Hub (Server)
...
open http://0.0.0.0:9900
Each node that connects to the Hub needs an account (email + secret):
...
## Part 3: Install Kanban Bridge (Plugin)
...
hermes plugins install <owner>/hermes-plugin-kanban-bridge --enable

# or a full Git URL
hermes plugins install https://github.com/<owner>/hermes-plugin-kanban-bridge --enable
```
...
│   └── AGENTS.md        # Trigger rule: activate both skills together
└── kanban-orchestrator/
...
![ Interactive architecture diagram showing the full agent serving topology.](hub2hub.png)
- [Multi-Hub Federation Plan](validated-frolicking-kahan_en.md) — W2 Bridge Agent dual-registration across multiple Hubs, enabling cross-hub task routing and orchestration.
